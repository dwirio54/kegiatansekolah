            ...
            <div class="card border-0">
                <div class="card-body">
                    @guest
                        ...
                        <div class="alert alert-primary mt-3 text-center text-dark">
