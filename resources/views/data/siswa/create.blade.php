                         ...
                         <div class="row">
                             <div class="col-md-3">
                                 <div class="form-group">
                                     ...
                                     <input type="text" name="nisn" class="form-control" id="" value="">
                                 </div>
                             </div>
                             <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="email" class="form-control" id="" placeholder="Masukan Email ANda">
                                </div>
                                </div>
                                <div class="col-md-3">
                                   <div class="form-group">
                             ...
                             <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control" id="" placeholder="+62">
                                </div>
                                </div>
                                <div class="col-md-12">
